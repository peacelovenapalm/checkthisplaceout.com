export default function AboutPage() {
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
      ...
      <section className="panel flex flex-col gap-4 border-2 border-[color:var(--border-color)] p-6 text-base">
        <h2 className="display-title text-xl text-[color:var(--color-cyan)]">
          How to use it
        </h2>
        <ol className="list-decimal space-y-2 pl-6 text-[color:var(--text-body)]">
          <li>Pick a category that matches your mood.</li>
          <li>Scan the cards and tap Details for the full story.</li>
          <li>Hit Directions and let Maps take over.</li>
        </ol>
      </section>
    </div>
  );
