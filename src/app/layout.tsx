...
export const metadata: Metadata = {
  ...
  description:
    "A local-friend Vegas guide with fast picks, short stories, and one-tap directions.",
  metadataBase: new URL("https://checkthisplaceout.com"),
  openGraph: {
    title: "Check This Place Out",
    description:
      "Fast Vegas picks in a friend-text voice. Tap a category, pick a spot, go now.",
    type: "website"
  }
};
        ...
        <div className="relative z-10 flex min-h-screen flex-col">
          ...
          <footer className="border-t border-[color:var(--border-color)] px-4 py-6 text-sm text-[color:var(--text-muted)] sm:px-6 lg:px-10">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <span>Built for fast Vegas decisions.</span>
